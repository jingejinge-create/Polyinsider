    ...
    <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 mb-6">
      <div className="flex flex-wrap items-center gap-4 lg:gap-6">
        <div>
          ...
          <select 
            className="bg-gray-800 border border-gray-700 rounded px-3 py-2 text-sm font-mono text-gray-300 focus:border-cyan-500 focus:outline-none min-w-[120px]"
        ...
        <div>
          ...
          <select
            className="bg-gray-800 border border-gray-700 rounded px-3 py-2 text-sm font-mono text-gray-300 focus:border-cyan-500 focus:outline-none min-w-[150px]"
